...
public final class DB
{
	...
	public static boolean select(String query, ReadStH reader, String errMsg)
	{
		...
		{
			if (errMsg == null)
				log.log(Level.WARNING, "Error executing select query " + e, e);
			else
				log.log(Level.WARNING, errMsg + " " + e, e);
			error = true;
		}
		finally
		{
			...
			{
				log.log(Level.WARNING, "Failed to close DB connection " + e, e);
			}
		}
	...
	public static boolean insertUpdate(String query, IUStH batch, String errMsg)
	{
		...
		{
			if (errMsg == null)
				log.log(Level.WARNING, "Failed to execute IU query " + e, e);
			else
				log.log(Level.WARNING, errMsg + " " + e, e);
