 ...
 * It should be subclasses by abstract class and that class has to implement method {@link #getClassName()}.<br>
 * This class must return {@link Class#getName()}, {@link #getClassName()} should be final.<br>
 * DAO subclass must have public no-arg constructor, in other case {@link InstantiationException} will be
 * thrown by {@link com.aionemu.commons.database.dao.DAOManager}
 *
 * @author SoulKeeper
 */
public interface DAO {
     ...
     * Must return {@link Class#getName()} of abstract class
