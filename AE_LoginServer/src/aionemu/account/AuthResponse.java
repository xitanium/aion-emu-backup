...
public enum AuthResponse
{
	...
	NO_GS_REGISTERED		(6), // No game server is registered to the authorizaton server.
	ALREADY_LOGGED_IN		(7), // You are already logged in.
	
	
	SERVER_DOWN				(8), // The selected server is down and not accessible.
	ERROR_9					(9), // The login information does not match the information you provided.
	NO_SUCH_ACCOUNT			(10), // No Login info available.
	KICK_GM_TOOLS			(11), // You are kicked out by the GM or other administration tools.
	ERROR_12				(12), // You are under the age limit.
	ALREADY_LOGGED_IN2		(13), // Attempted to log in when you are already logged in.
	ALREADY_LOGGED_IN3		(14), // You are already playing the game.
	SERVER_DOWN2			(15), // The server is not available now.
	CONNECT_ONLY_GM			(16), // Currently onle GMs are allowed to connect to the server.
	...
	NO_TWOBOX_ONE_PC		(35), // Multiple client loading from one computer is not allowed in an Internet Cafe.
