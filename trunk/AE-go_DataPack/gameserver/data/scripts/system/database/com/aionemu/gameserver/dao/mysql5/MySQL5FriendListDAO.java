 ...
 */
package com.aionemu.gameserver.dao.mysql5;
...
import com.aionemu.loginserver.dao.mysql5.MySQL5DAOUtils;
...
public class MySQL5FriendListDAO extends FriendListDAO
{
	 ...
	 */
	@Override
	public FriendList load(final Player player, final World world)
	{
		...
		DB.select(LOAD_QUERY, new ParamReadStH()
		{
			...
			public void handleRead(ResultSet rs) throws SQLException
			{
				...
				while (rs.next()) 
				{
					...
					PlayerCommonData pcd = dao.loadPlayerCommonData(objId, world);
