...
public class CM_FRIEND_ADD extends AionClientPacket
{
	...
	protected void runImpl()
	{
		...
		{
			sendPacket(new SM_SYSTEM_MESSAGE(SM_SYSTEM_MESSAGE.STR_BUDDYLIST_LIST_FULL));
		}
		...
		else // Send request
		{
			...
			if (!requested)
			{
				sendPacket(new SM_SYSTEM_MESSAGE(SM_SYSTEM_MESSAGE.STR_BUDDYLIST_BUSY, targetName));
			}
			else 
			{
